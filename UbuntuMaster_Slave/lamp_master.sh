...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=TrippyStorm/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=TrippyStorm/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=TrippyStorm/' /var/www/html/laravel/.env
